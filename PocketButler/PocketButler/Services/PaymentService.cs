...
namespace PocketButler
{
	public class PaymentService : BaseService
	{
		...
		public static String GetShoppingCart(String restaurantName, String restaurantId, List<PocketButler.ProcessPaymentPage.Menu_Table_Item> menu_item_list, String tableNumber, String deliveryType, String deliveryCharges, String servicePointName, String paymentType)
		{
