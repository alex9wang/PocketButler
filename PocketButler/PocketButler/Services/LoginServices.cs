...
//				GoogleAnalyticsTracker.TrackExceptionInGoogleAnalytics (e, false);
		...
		public async static Task<UserInfoResult> RegisterUser (String email, String password, String firstName, String lastName, String dob, String deviceToken, String deviceType, String profileImage, bool cacheData = true)
		{
			try {
