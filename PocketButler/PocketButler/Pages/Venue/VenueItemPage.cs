...
namespace PocketButler
{
	public class VenueItemPage : BasePage
	{
		...
		public VenueItemPage (RestaurantInfo info, Action RefreshEvent)
		{
		...
		private void BuildUI()
		{
			...
			{
				Source = RestaurantData.image,//RestaurantData.image_large,
				Aspect = Aspect.AspectFit
			};
			AbsoluteLayout.SetLayoutFlags(ItemImage, AbsoluteLayoutFlags.All);
			AbsoluteLayout.SetLayoutBounds(ItemImage, new Rectangle(0.5, 0.1, 0.4, 0.6));
