...
namespace PocketButler
{
	public class VenueCustomizePage : BasePage
	{
		...
		public VenueCustomizePage (String item_id, String isOnline, String customization, int uid, bool isFromCart, Action refresh)
		{
		...
		//Edit
		public VenueCustomizePage (String item_id, String isOnline, String customization, int uid, bool isFromCart, List<PaymentExtraItem> extras, List<PaymentTypeItem> types, Action refresh)
		{
			this.Item_id = item_id;
			this.IsOnline = (isOnline == "0");
			this.Customization = customization;
		...
		private void BuildUI()
		{
			...
			if (IsOnline == true && Itemdata.types != null && Itemdata.types.Count > 0) {
			...
			if (IsOnline == true && Itemdata.extras != null && Itemdata.extras.Count > 0) {
			...
			if (IsOnline == true && IsFromCart == false && Itemdata.related_items != null && Itemdata.related_items.Count > 0) {
				...
				RelatedListView.ItemSelected += async (object sender, SelectedItemChangedEventArgs e) => {
					...
					if (itemInfo != null)
					{
						var venueCustomizePage = new VenueCustomizePage(itemInfo.item_id, "0", "", -1, false, PageShowingEvent);
